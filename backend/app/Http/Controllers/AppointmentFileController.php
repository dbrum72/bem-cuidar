...
class AppointmentFileController extends Controller {
    ...
    public function destroy(AppointmentFile $file) {
        
        if($file && $file->delete()) {

            Storage::disk('public')->delete('appointments/'.$file->storaged);

            return response()->json([ 'errors' => [], 'msg' => 'Arquivo removido com sucesso!'], 200);            
        }
